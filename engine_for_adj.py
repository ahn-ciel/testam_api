...
from model_for_adj import *
import util
class trainer():
    def __init__(self, scaler, in_dim, out_dim, num_nodes, nhid, dropout, device, 
                 lr_mul = 1, n_warmup_steps = 4000, quantile = 0.7, is_quantile = False, warmup_epoch = 0,
                 use_uncertainty = False, supports = None):
        self.model = TESTAM(num_nodes, dropout, in_dim=in_dim, out_dim=out_dim, hidden_size=nhid, supports = supports)
